...
pub fn draw_centered_text_box(cx: f32, cy: f32, w: f32, h: f32, box_color: Color, text: &str, text_color: Color) {
    ...
    draw_rectangle_lines(x, y, w, h, 2.0, game_data::constants::BORDER_COLOUR);
...
pub fn draw_tank(x: f32, y: f32, w: f32, h: f32) {
    draw_rectangle(x, y, w, h, game_data::constants::TANK_COLOUR);
    draw_rectangle_lines(x, y, w, h, 5.0, game_data::constants::TANK_BORDER_COLOUR);
}
