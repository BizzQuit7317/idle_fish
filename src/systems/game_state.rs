...
pub struct GameState {
    pub tank: tank::tank::Tank,
    pub player: systems::player::Player,
    pub economy: systems::economy::Economy,
    pub notification: util::ui_helper::Notification,
    pub offline_report: systems::offline_report::OfflineReport,
    pub fish_registry: game_data::registry::FishRegistry,
    pub debugger: util::debug::Debugger,
}

impl GameState {
    pub fn new() -> GameState {
        let mut state = GameState {
            tank: tank::tank::Tank::new(),
            player: systems::player::Player::new(),
            economy: systems::economy::Economy::new(),
            notification: util::ui_helper::Notification::new(),
            offline_report: systems::offline_report::OfflineReport::new(),
            fish_registry: game_data::registry::FishRegistry::load(),
            debugger: util::debug::Debugger::new(),
        };
            ...
            if !fish.alive {
                for fish_trait in &fish.fish_traits {
                    match fish_trait.trait_name {
                        tank::traits::TraitNames::TempratureBoost => self.tank.water_parameters.temprature /= fish_trait.multiplier,
                        tank::traits::TraitNames::AmmoniaBoost => self.tank.water_parameters.ammonia /= fish_trait.multiplier,
                        tank::traits::TraitNames::PHBoost => self.tank.water_parameters.ph /= fish_trait.multiplier,
                        tank::traits::TraitNames::GHBoost => self.tank.water_parameters.gh /= fish_trait.multiplier,
                        tank::traits::TraitNames::NitrateBoost => self.tank.water_parameters.nitrate /= fish_trait.multiplier,
                        tank::traits::TraitNames::NitriteBoost => self.tank.water_parameters.nitrite /= fish_trait.multiplier,
                    }
                }
            }
        }
